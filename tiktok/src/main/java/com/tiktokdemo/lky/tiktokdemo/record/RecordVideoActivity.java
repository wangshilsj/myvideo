...
//                hintView120.setBackgroundResource(R.drawable.bg_tidal_pat_record_time_red_cricle);
    ...
    public void onClick(View v) {
        ...
        if (v.getId() == R.id.tidal_pat_record_video_back_img) {
            onBackPressed();
        } else if (v.getId() == R.id.tidal_pat_record_video_flash_img) {
            ...
            mPresenter.changeFlashMode();
        } else if (v.getId() == R.id.tidal_pat_record_video_flip_img) {
            mPresenter.switchCamera();
        } else if (v.getId() == R.id.tidal_pat_record_video_save_img) {
            if (mPresenter.isCombining()) {
                return;
            }
        ...
        } else if (v.getId() == R.id.tidal_pat_record_video_cut_music_img) {
            ...
            showCutAudioLayout();
        } else if (v.getId() == R.id.tidal_pat_record_video_beauty_img) {
            mPresenter.changeBeautyOpen();
        } else if (v.getId() == R.id.tidal_pat_record_video_filter_img) {
            //滤镜
            showFilterRecycler();
        } else if (v.getId() == R.id.tidal_pat_record_video_count_down_img) {
        ...
        } else if (v.getId() == R.id.tidal_pat_record_video_count_down_img_3) {
            //倒计时3
            if (mPresenter.isCurrentRecordMax() || !isCanRecord) {
                return;
            }
            hideCountDownLayout(VIDEO_COUNT_DOWN_TIME_3);
        } else if (v.getId() == R.id.tidal_pat_record_video_count_down_img_6) {
            if (mPresenter.isCurrentRecordMax() || !isCanRecord) {
                return;
            }
            hideCountDownLayout(VIDEO_COUNT_DOWN_TIME_6);
        } else if (v.getId() == R.id.tidal_pat_record_video_count_down_img_9) {
            if (mPresenter.isCurrentRecordMax() || !isCanRecord) {
                return;
            }
            hideCountDownLayout(VIDEO_COUNT_DOWN_TIME_9);
        } else if (v.getId() == R.id.tidal_pat_record_cut_audio_confirm_img) {
            //剪音乐完成
            if (mPresenter.isAudioCuting()) {
                return;
            }
            cutAudioFinish();
        } else if (v.getId() == R.id.tidal_pat_record_delete_view) {
            //删除按钮
        ...
        } else if (v.getId() == R.id.tidal_pat_record_filter_layout) {
            hideFilterRecycler();
        }
    }
